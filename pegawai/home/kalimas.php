        ...
        <div class="card text-center h-50">
          ...
          <div class="card-body">
            ...
            <?php if (mysqli_num_rows($cek_presensi_masuk) === 0) { ?>
              <!-- Tampilkan form presensi jika belum ada presensi hari ini -->
              ...
              <form method="POST" action="<?= '../../pegawai/presensi/presensi_masuk_s.php' ?>">
                ...
                <div style="display: flex; gap: 10px;">
                  <button type="submit" name="tombol_masuk" class="btn btn-blue mt-3" formaction="../presensi/presensi_masuk_h.php">Masuk</button>
                </div>
              </form>
            <?php } else { ?>
              <!-- Tampilkan status jika sudah ada presensi hari ini -->
              <i class="fa-regular fa-circle-check fa-4x text-success"></i>
              <?php if ($data_presensi_hari_ini['tanggal_keluar'] === NULL) { ?>
                <h4 class="my-3">Anda telah melakukan <br> presensi MASUK</h4>
              <?php } else { ?>
                <h4 class="my-3">Anda telah melakukan <br> presensi MASUK & KELUAR hari ini</h4>
              <?php } ?>
            <?php } ?>
          </div>
