            ...
            <?php if (mysqli_num_rows($cek_presensi_masuk) === 0) { ?>
              ...
              <form method="POST" action="<?= '../../pegawai/presensi/presensi_masuk_s.php' ?>">
                ...
                <div style="display: flex; gap: 10px;">
                  <button type="submit" name="tombol_masuk" class="btn btn-blue mt-3" formaction="../presensi/presensi_masuk_a.php">Pagi</button>
                  <button type="submit" name="tombol_masuk" class="btn btn-orange mt-3" formaction="../presensi/presensi_masuk_b.php">Sore</button>
                </div>
              </form>
            <?php } else {
              // Jika sudah presensi masuk hari ini, tampilkan pesan
            ?>
              <i class="fa-regular fa-circle-check fa-4x text-success"></i>
              <h4 class="my-3">Anda telah melakukan <br> presensi MASUK hari ini</h4>
            <?php } ?>
          </div>
