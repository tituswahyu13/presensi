...
<style>
    /* Variabel warna */
    :root {
        --primary-color: #4a90e2; /* Warna biru yang lebih cerah */
        --primary-hover: #357ab8; /* Warna biru gelap saat hover */
        --secondary-color: #7f8c8d; /* Warna abu-abu */
        --success-color: #2ecc71; /* Warna hijau */
        --danger-color: #e74c3c; /* Warna merah */
        --warning-color: #f39c12; /* Warna oranye */
        --background-light: #ffffff; /* Warna latar belakang putih */
        --border-color: #bdc3c7; /* Warna border */
        --text-dark: #2c3e50; /* Warna teks gelap */
        --text-muted: #95a5a6; /* Warna teks pudar */
    }
    ...
    .table {
        border-radius: 10px;
        overflow: hidden;
        box-shadow: none; /* Menghapus bayangan untuk tampilan minimalis */
    }
    ...
    .table tbody tr {
        background-color: transparent; /* Menghapus warna latar belakang baris tabel */
    }

    .table tbody td {
        background-color: transparent; /* Menghapus warna latar belakang sel tabel */
        border: none; /* Menghapus border untuk tampilan lebih bersih */
    }
