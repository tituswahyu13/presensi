...
$stmt_shift = mysqli_prepare($connection, "SELECT masuk_i, pulang_i FROM shift WHERE id = 1");
...
if (!$shift_data || empty($shift_data['masuk_i']) || empty($shift_data['pulang_i'])) {
...
if (mysqli_num_rows($checkResult) > 0) {
    ...
    mysqli_stmt_bind_param($stmt_insert, "isss", $id_pegawai, $file, $shift_data['masuk_i'], $shift_data['pulang_i']);
