...
//   $zona_waktu = $_POST['zona_waktu'];
  ...
  if (mysqli_query($connection, $query)) {
    echo "<script>alert('Pengajuan sakit berhasil dikirim!'); window.location.href='../home/{$from_page}';</script>";
  } else {
    echo "<script>alert('Pengajuan sakit gagal!'); window.location.href='../home/{$from_page}';</script>";
  }
} else {
