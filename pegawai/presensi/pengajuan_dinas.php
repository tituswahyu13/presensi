...
//   $zona_waktu = $_POST['zona_waktu'];
  ...
  $query = "INSERT INTO absensi (id_pegawai, tanggal_absen, jam_absen, keterangan) 
            VALUES ('$id_pegawai', '$tanggal_pengajuan', '$jam_pengajuan', '$jenis_pengajuan')";

  if (mysqli_query($connection, $query)) {
    echo "<script>alert('Pengajuan dinas berhasil dikirim!'); window.location.href='../home/{$from_page}';</script>";
  } else {
    echo "<script>alert('Pengajuan dinas gagal!'); window.location.href='../home/{$from_page}';</script>";
  }
} else {
