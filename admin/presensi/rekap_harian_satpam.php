...
$judul = "Rekap Presensi Harian Satpam";
...
// Kueri yang Diperbaiki: Jadwal Satpam sebagai Tabel Utama
$query = "
    SELECT
        p.id AS pegawai_id,
        p.nama,
    ...
    WHERE
        p.lokasi_presensi IN ('kantor PDAM', 'satpam')
        AND u.status = 'aktif'
        ...
        <div class="action-buttons">
            <div class="col-md-12" style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                <form id="filterForm" method="GET" class="date-filter" style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                    ...
                    <button type="submit" formaction="rekap_satpam_excel.php" class="btn btn-primary export-btn">
                        📊 Export Excel
                    </button>
                </form>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="filter-buttons">
                    ...
                    <button class="btn btn-primary" onclick="location.href='../presensi/rekap_harian_satpam.php'">👮 Satpam</button>
